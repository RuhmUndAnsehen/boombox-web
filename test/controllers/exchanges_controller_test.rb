...
class ExchangesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create exchange" do
    assert_difference("Exchange.count") do
      post exchanges_url, params: { exchange: { country_id: @exchange.country_id, name: @exchange.name, symbol: @exchange.symbol } }
    end
  ...
  test "should update exchange" do
    patch exchange_url(@exchange), params: { exchange: { country_id: @exchange.country_id, name: @exchange.name, symbol: @exchange.symbol } }
